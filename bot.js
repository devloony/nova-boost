...
app.post("/api/order",async(req,res)=>{
 try{
  ...
  const normalizedUsername = String(bodyUser.username || telegramUser?.username || "")
    .trim().replace(/^@+/, "");
  const orderUser = telegramUser
    ? {
        ...telegramUser,
        username: String(telegramUser.username || normalizedUsername || "").trim().replace(/^@+/, "") || null
      }
    : {
        id: bodyUser.id || null,
        username: normalizedUsername || null,
        first_name: bodyUser.first_name || null,
        last_name: bodyUser.last_name || null
      };
